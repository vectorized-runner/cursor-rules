...
| `rules/50-company/` | Infrastructure | SharedSingletonBehaviour / game SingletonBehaviour, ResourceManager/AssetGroup catalog, asmdef architecture, pure DTO contracts, modal input blocking, UI safe area |
